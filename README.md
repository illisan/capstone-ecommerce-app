...
<ul>
  <li>Items search with the SeachIndex of ‘All’.</li>
  <li>Keywords:keyword is a variable representing the use input.</li>
  <li>Search query is requested with user input as well as hard-coded keywords: fair trade, organic, ethical.</li>
